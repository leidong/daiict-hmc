										...
										switch ($exportOptions['cc_label'][$ID]) {
											case '_downloadable_files':
												...
												if (!empty($files)){
													...
													if (!in_array($element_name, $woo)) $woo[] = $element_name . '_paths';

													$article[$element_name . '_names'] = implode($implode_delimiter, $file_names);										
													if (!in_array($element_name, $woo)) $woo[] = $element_name . '_names';
											...
											default:
												if (empty($article[$element_name])){
													...
													if (!in_array($element_name, $woo)) $woo[] = $element_name;
												}
												else{
													...
													if (!in_array($element_name . '_' . $key, $woo)) $woo[] = $element_name . '_' . $key;
												}
												break;
										}		
									}
