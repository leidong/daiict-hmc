						...
						foreach ($section['meta'] as $cur_meta_key => $cur_meta_label) {									
							...
							<li class="pmxe_<?php echo $slug; ?>">
								<div class="custom_column" rel="<?php echo ($i + 1);?>">
									<label class="wpallexport-xml-element">&lt;<?php echo $cur_meta_label; ?>&gt;</label>
									...
									<input type="hidden" name="cc_options[]" value="<?php echo $slug;?>"/>										
									<input type="hidden" name="cc_type[]" value="woo_order"/>
									<input type="hidden" name="cc_value[]" value="<?php echo $cur_meta_key; ?>"/>
									<input type="hidden" name="cc_name[]" value="<?php echo $cur_meta_label;?>"/>
								</div>
							</li>
							<?php
							$i++;												
