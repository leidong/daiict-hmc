		        	...
		        	<div class="wpallexport-upload-resource-step-one rad4">						
						...
						<div class="wpallexport-upload-type-container" rel="advanced_type">						
							<div class="wpallexport-file-type-options">
								...
								<textarea class="wp_query" rows="10" cols="80" name="wp_query" placeholder="'post_type' => 'post', 'post_status' => array( 'pending', 'draft', 'future' )" style="margin-right: 25px;"><?php echo esc_html($post['wp_query']); ?></textarea>						
